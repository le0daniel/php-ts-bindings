...
dataset('metadata positions', [
    ...
    'named utility' => "Named<'Tok', string>",
    'branded utility' => "Branded<'tok', string>",
    'branded utility over named utility' => "Branded<'tok', Named<'Token', string>>",
    'named utility in struct' => "array{t: Named<'Tok', string>}",
    'branded utility over named class' => "Branded<'contact', ".Customer::class.'>',
